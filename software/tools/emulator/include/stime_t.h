...
extern bool stime_compareE(stime_t *a, stime_t *b);
extern bool stime_compareNE(stime_t *a, stime_t *b);
extern bool stime_compareL(stime_t *a, stime_t *b);
extern bool stime_compareM(stime_t *a, stime_t *b);
extern bool stime_compareLE(stime_t *a, stime_t *b);
extern bool stime_compareME(stime_t *a, stime_t *b);
...
extern bool timeHasPassed(stime_t interval, stime_t start, stime_t now);
