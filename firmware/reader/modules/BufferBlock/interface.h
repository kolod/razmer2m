...
struct BufferBlock_st {
	...
	result_t (*writeAll)(BufferBlock *, uint8_t);
...
extern result_t bufferBlock_writeAll(BufferBlock *self, uint8_t v);
...
extern size_t bufferBlock_getLength(BufferBlock *self);
